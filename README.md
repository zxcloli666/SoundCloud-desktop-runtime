...
| --- | :---: | --- | --- | --- |
| `react-native` | ✅ | `0.87.0` | 2026-07-02 | `0.86.0` → `0.86.2` → `0.87.0` |
| `@shopify/react-native-skia` | ✅ | `2.11.0` | 2026-07-02 | `2.6.9` → `2.7.0` → `2.9.0` → `2.10.0` → `2.10.1` → `2.11.0` |
| `react-native-reanimated` | ✅ | `4.5.3` | 2026-07-02 | `4.5.0` → `4.5.1` → `4.5.2` → `4.5.3` |

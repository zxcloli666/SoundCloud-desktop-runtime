...
| `@shopify/react-native-skia` | ✅ | `2.12.0` | 2026-07-02 | `2.6.9` → `2.7.0` → `2.9.0` → `2.10.0` → `2.10.1` → `2.11.0` → `2.11.1` → `2.11.2` → `2.12.0` |
| `react-native-reanimated` | ✅ | `4.7.0` | 2026-07-02 | `4.5.0` → `4.5.1` → `4.5.2` → `4.5.3` → `4.6.0` → `4.7.0` |
